...
import cm.android.preference.security.crypto2.CryptoHelper;
import cm.android.preference.security.crypto2.ICipher;

public class SecureSharedPreferences2 implements SharedPreferences {
    ...
    public SecureSharedPreferences2(SharedPreferences original, ICipher valueCipher) {
        this.prefs = original;
        helper = new CryptoHelper(valueCipher);
    }
